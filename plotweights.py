...
for layer_name in ['block5_conv1', 'block5_conv2', 'block5_conv3']:
    ...
    for filter_index in range(0, 512):
        ...
        print('Processing filter %d - kept %d' % (filter_index, len(kept_filters)))
    ...
    # our 5 x 5 filters of size 60 x 200, with a 5px margin in between
    margin = 5
    ...
    imsave('imgs/%s_filters_%dx%d.png' % (layer_name, n, n), stitched_filters)
